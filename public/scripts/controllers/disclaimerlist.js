            ...
            $http.get(getDisclaimerUrl, config)
                .then(function(data, status, config) {
                    ...
                    angular.forEach(Disclaimer.data, function(Disclaimer) {
                        Disclaimer.country = Disclaimer.country !== null ? Disclaimer.country.trim() : '';
                        Disclaimer.language = Disclaimer.language !== null ? Disclaimer.language.trim() : '';
                        Disclaimer.content = Disclaimer.content !== null ? Disclaimer.content.trim() : '';
                    });
