...
router.post('/insertNeedleIssue1', function(req, res) {
...
router.post('/insertDiviceGeneralFunctioning1', function(req, res) {
    console.log('............insertDecisiontree...............');   
    pg.connect(process.env.DATABASE_URL, function (err, conn, done) {
        if (err) console.log(err);       
...
router.post('/insertDataandtransfer1', function(req, res) {
    console.log('............insertDecisiontree...............');   
    pg.connect(process.env.DATABASE_URL, function (err, conn, done) {
        if (err) console.log(err);       
...
router.post('/insertPowerFailure1', function(req, res) {
    console.log('............insertDecisiontree...............');   
    pg.connect(process.env.DATABASE_URL, function (err, conn, done) {
        if (err) console.log(err);       
...
router.post('/insertCatridgeIssue1', function(req, res) {
    console.log('............insertDecisiontree...............');   
    pg.connect(process.env.DATABASE_URL, function (err, conn, done) {
        if (err) console.log(err);       
