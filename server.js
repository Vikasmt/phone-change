		 ...
		 conn.query('SELECT *from salesforce.Case WHERE id='+caseid+'',
                function(err,result){
                 if (err != null || result.rowCount == 0) {
			        ...
			        var valueData = '(jsonData.DeviceName !== undefined && jsonData.DeviceName !== null && jsonData.DeviceName !== "null" && jsonData.DeviceName.toString().length > 0) ? 'FMA_DeviceName__c = \''+jsonData.userid+'\','+ : 'FMA_DeviceName__c = \'\','+
                                    '(jsonData.userid !== undefined && jsonData.userid !== null && jsonData.userid !== "null" && jsonData.userid.toString().length > 0) ? 'ContactId = \''+jsonData.userid+'\','+ : 'ContactId = \'\','+
									'(jsonData.ProductId !== undefined && jsonData.ProductId !== null && jsonData.ProductId !== "null" && jsonData.ProductId.toString().length > 0) ? 'FMA_Product__c = \''+jsonData.ProductId+'\','+ : 'FMA_Product__c = \'\','+
									'(jsonData.Gender !== undefined && jsonData.Gender !== null && jsonData.Gender !== "null" && jsonData.Gender.toString().length > 0) ? 'FMA_Product__c = \''+jsonData.Gender+'\','+ : 'FMA_Product__c = \'\','+
									'(jsonData.FormulationDosage !== undefined && jsonData.FormulationDosage !== null && jsonData.FormulationDosage !== "null" && jsonData.FormulationDosage.toString().length > 0) ? 'FMA_Dosage__c = \''+jsonData.FormulationDosage+'\','+ : 'FMA_Dosage__c = \'\','+
									'(jsonData.TrainingDate !== undefined && jsonData.TrainingDate !== null && jsonData.TrainingDate !== "null" && jsonData.TrainingDate.toString().length > 0) ? 'FMA_Whenthepatientgottrained__c = \''+jsonData.TrainingDate+'\','+ : 'FMA_Whenthepatientgottrained__c = \'\','+
									'(jsonData.ComplainantCategory !== undefined && jsonData.ComplainantCategory !== null && jsonData.ComplainantCategory !== "null" && jsonData.ComplainantCategory.toString().length > 0) ? 'FMA_ComplainantCategory__c = \''+jsonData.ComplainantCategory+'\','+ : 'FMA_ComplainantCategory__c = \'\','+
									'(jsonData.AffiliateIfStillNeeded !== undefined && jsonData.AffiliateIfStillNeeded !== null && jsonData.AffiliateIfStillNeeded !== "null" && jsonData.AffiliateIfStillNeeded.toString().length > 0) ? 'FMA_AffiliateIfStillNeeded__c = \''+jsonData.AffiliateIfStillNeeded+'\','+ : 'FMA_AffiliateIfStillNeeded__c = \'\','+
									'(jsonData.BatchSerialNbr !== undefined && jsonData.BatchSerialNbr !== null && jsonData.BatchSerialNbr !== "null" && jsonData.BatchSerialNbr.toString().length > 0) ? 'FMA_BatchSerialnumber__c = \''+jsonData.BatchSerialNbr+'\','+ : 'FMA_BatchSerialnumber__c = \'\','+
									'(jsonData.DateOfFirstUse !== undefined && jsonData.DateOfFirstUse !== null && jsonData.DateOfFirstUse !== "null" && jsonData.DateOfFirstUse.toString().length > 0) ? 'FMA_Dateoffirstuse__c = \''+jsonData.DateOfFirstUse+'\','+ : 'FMA_Dateoffirstuse__c = \'\','+
									'(jsonData.InitialPatientName !== undefined && jsonData.InitialPatientName !== null && jsonData.InitialPatientName !== "null" && jsonData.InitialPatientName.toString().length > 0) ? 'FMA_Initialpatientname__c = \''+jsonData.InitialPatientName+'\','+ : 'FMA_Initialpatientname__c = \'\','+
									'(jsonData.InitialPatientSurName !== undefined && jsonData.InitialPatientSurName !== null && jsonData.InitialPatientSurName !== "null" && jsonData.InitialPatientSurName.toString().length > 0) ? 'FMA_Initialpatientsurname__c = \''+jsonData.InitialPatientSurName+'\','+ : 'FMA_Initialpatientsurname__c = \'\','+
									'(jsonData.Age !== undefined && jsonData.Age !== null && jsonData.Age !== "null" && jsonData.Age.toString().length > 0) ? 'FMA_Age__c = \''+jsonData.Age+'\','+ : 'FMA_Age__c = \'\','+
									'(jsonData.Phoneno !== undefined && jsonData.Phoneno !== null && jsonData.Phoneno !== "null" && jsonData.Phoneno.toString().length > 0) ? 'FMA_Phoneno__c = \''+jsonData.Phoneno+'\','+ : 'FMA_Phoneno__c = \'\','+
									'(jsonData.Email !== undefined && jsonData.Email !== null && jsonData.Email !== "null" && jsonData.Email.toString().length > 0) ? 'FMA_Email__c = \''+jsonData.Email+'\','+ : 'FMA_Email__c = \'\','+
									'(jsonData.Hasthepatientbeentrained !== undefined && jsonData.Hasthepatientbeentrained !== null && jsonData.Hasthepatientbeentrained !== "null" && jsonData.Hasthepatientbeentrained.toString().length > 0) ? 'FMA_Hasthepatientbeentrained__c = \''+jsonData.Hasthepatientbeentrained+'\','+ : 'FMA_Hasthepatientbeentrained__c = \'\','+
									'(jsonData.WhomadetheTrainingOther !== undefined && jsonData.WhomadetheTrainingOther !== null && jsonData.WhomadetheTrainingOther !== "null" && jsonData.WhomadetheTrainingOther.toString().length > 0) ? 'Who_made_the_training_Other__c = \''+jsonData.WhomadetheTrainingOther+'\','+ : 'Who_made_the_training_Other__c = \'\','+
									'(jsonData.NameOfCompliant !== undefined && jsonData.NameOfCompliant !== null && jsonData.NameOfCompliant !== "null" && jsonData.NameOfCompliant.toString().length > 0) ? 'FMA_NameofComplainant__c = \''+jsonData.NameOfCompliant+'\','+ : 'FMA_NameofComplainant__c = \'\','+
									'(jsonData.DefectDescription !== undefined && jsonData.DefectDescription !== null && jsonData.DefectDescription !== "null" && jsonData.DefectDescription.toString().length > 0) ? 'FMA_Defectdescription__c = \''+jsonData.DefectDescription+'\','+ : 'FMA_Defectdescription__c = \'\','+
									'(jsonData.IsComplaintSampleAvailable !== undefined && jsonData.IsComplaintSampleAvailable !== null && jsonData.IsComplaintSampleAvailable !== "null" && jsonData.IsComplaintSampleAvailable.toString().length > 0) ? 'FMA_Isthecomplaintsampleavailable__c = \''+jsonData.IsComplaintSampleAvailable+'\','+ : 'FMA_Isthecomplaintsampleavailable__c = \'\','+
									'(jsonData.HasResponseBeenRequested !== undefined && jsonData.HasResponseBeenRequested !== null && jsonData.HasResponseBeenRequested !== "null" && jsonData.HasResponseBeenRequested.toString().length > 0) ? 'FMA_Hasresponsebeenrequested__c = \''+jsonData.HasResponseBeenRequested+'\','+ : 'FMA_Hasresponsebeenrequested__c = \'\','+
									'(jsonData.IsPatientFamiliarWithDeviceUsage !== undefined && jsonData.IsPatientFamiliarWithDeviceUsage !== null && jsonData.IsPatientFamiliarWithDeviceUsage !== "null" && jsonData.IsPatientFamiliarWithDeviceUsage.toString().length > 0) ? 'FMA_Ispatientfamiliarwithdeviceusage__c = \''+jsonData.IsPatientFamiliarWithDeviceUsage+'\','+ : 'FMA_Ispatientfamiliarwithdeviceusage__c = \'\','+
									'(jsonData.SinceWhenPatientUseThisDevice !== undefined && jsonData.SinceWhenPatientUseThisDevice !== null && jsonData.SinceWhenPatientUseThisDevice !== "null" && jsonData.SinceWhenPatientUseThisDevice.toString().length > 0) ? 'FMA_Sincewhendoespatientusethiskind__c = \''+jsonData.SinceWhenPatientUseThisDevice+'\','+ : 'FMA_Sincewhendoespatientusethiskind__c = \'\',';
