...
router.post('/CreateUser', function(req, res) {
    ...
    var formattedData='INSERT INTO Salesforce.Contact (firstname, lastname, email, phone, Password__c, IVOPMobileappuser__c) VALUES (\''+jsonData.firstname+'\', \''+jsonData.lastname+'\', \''+jsonData.email+'\', \''+jsonData.phone+'\', \''+jsonData.password+'\', \''+'True'+'\')  RETURNING id';
        ...
        conn.query(
             ...
             function(err, result){
                ...
                if(result.rows[0].count > 0){
                    ...
                    conn.query('INSERT INTO Salesforce.Contact (firstname, lastname, email, phone, Password__c, IVOPMobileappuser__c, MailingCountry) VALUES (\''+jsonData.firstname+'\', \''+jsonData.lastname+'\', \''+jsonData.email.toLowerCase().trim()+'\', \''+jsonData.phone+'\', \''+jsonData.password+'\', \''+'True'+'\', \''+jsonData.country+'\')  RETURNING id',
                         function(err, result) {
                            if(err){
                                    return res.json({
                                            msgid: 2,
